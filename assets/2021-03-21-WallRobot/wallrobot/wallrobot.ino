...
static Stepper m1((int)STEPS_PER_TURN, 4, 5);         //STEPSPERTURN, DIR, STEP, (MS1, MS2, MS3)
static Stepper m2((int)STEPS_PER_TURN, 9, 8);  
...
float SPOOL_DIAMETER1 = 0.6;
float THREADPERSTEP1;  // thread per step

float SPOOL_DIAMETER2 = 0.6;
